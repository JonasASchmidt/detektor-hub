...
export default function FindingDashboard({
  ...
  const allKpis = [
    ...
    },
    {
      ...
      icon: Calendar,
      href: `/findings?dateFrom=${monthStart}`,
    },
    {
      label: "Top Tag",
      ...
      icon: Tag,
      href: stats?.mostUsedTag ? `/findings?tags=${stats.mostUsedTag.id}` : undefined,
    ...
    },
    {
      ...
      icon: MessageSquare,
      href: "/findings?hasComments=true",
    },
  ];
