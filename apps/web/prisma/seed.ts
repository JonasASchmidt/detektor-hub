...
const DEMO_FINDINGS: FindingSeed[] = [
  {
    ...
    dating: "161–180 n. Chr.", datingFrom: 161, datingTo: 180,
    depth: 18, weight: 3.1,
  ...
  },
  {
    ...
    dating: "13. Jahrhundert", datingFrom: 1200, datingTo: 1299,
    depth: 12, weight: 0.9,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: true,
    dating: "2.–3. Jh. n. Chr.", datingFrom: 100, datingTo: 300,
    depth: 8, weight: 14.5,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "Mittelalter", datingFrom: 900, datingTo: 1400,
    depth: 22, weight: 85,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "19. Jahrhundert", datingFrom: 1815, datingTo: 1871,
    depth: 6, weight: 4.2,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: true,
    dating: "14.–15. Jh.", datingFrom: 1300, datingTo: 1500,
    depth: 9, weight: 7.8,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "4. Jh. n. Chr.", datingFrom: 300, datingTo: 400,
    depth: 14, weight: 4.8,
    tags: ["Römerzeit"],
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "15.–16. Jh.", datingFrom: 1400, datingTo: 1600,
    depth: 17, weight: 32,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "Unbekannt", datingFrom: 1000, datingTo: 2000,
    depth: 5, weight: 120,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "1.–2. Jh. n. Chr.", datingFrom: 50, datingTo: 200,
    depth: 25,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: true,
    dating: "6.–8. Jh.", datingFrom: 500, datingTo: 800,
    depth: 11, weight: 28,
  ...
  },
  {
    ...
    dating: "20. Jahrhundert", datingFrom: 1939, datingTo: 1945,
    depth: 3,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: true,
    dating: "2.–1. Jh. v. Chr.", datingFrom: -200, datingTo: -1,
    depth: 19, weight: 2.6,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "17.–18. Jh.", datingFrom: 1600, datingTo: 1800,
    depth: 7, weight: 5.1,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "1650", datingFrom: 1650, datingTo: 1650,
...
const JONAS_FINDINGS: DetailedFindingSeed[] = [
  {
    ...
    status: "COMPLETED", reported: true,
    dating: "1.–2. Jh. n. Chr.", datingFrom: 1, datingTo: 200,
    ...
    descriptionFront: "Halbkreisförmiger Bügel mit zentraler Rippe, Inschrift \"AVCISSA\" schwach lesbar.",
    descriptionBack: "Nadelrast und Spiralmechanismus vollständig erhalten, leichte Korrosion an der Spirale.",
    tags: ["Fibel", "Römerzeit"],
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "13.–14. Jh.", datingFrom: 1200, datingTo: 1399,
    ...
    descriptionFront: "Ovaler, glatter Reif aus Goldlegierung mit leicht abgeplatteter Außenfläche.",
    descriptionBack: "Innenfläche poliert, keine Gravur. Minimale Gebrauchsspuren.",
  ...
  },
  {
    ...
    status: "COMPLETED", reported: true,
    dating: "1813–1866", datingFrom: 1813, datingTo: 1866,
    ...
    descriptionFront: "Vorderseite: Preußischer Adler mit Landwehrkreuz auf der Brust, Umschrift \"MIT GOTT FÜR KÖNIG UND VATERLAND\".",
    descriptionBack: "Öse intakt, Herstellerstempel \"WILH. SCHÜLER / BERLIN\" gut lesbar.",
    tags: ["Uniformknopf"],
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "Hochmittelalter", datingFrom: 1000, datingTo: 1300,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "1.–3. Jh. n. Chr.", datingFrom: 1, datingTo: 300,
    ...
    descriptionFront: "Eberkopf von vorn, markante Hauerzähne, Rillen zur Andeutung des Fells.",
    descriptionBack: "Öse intakt, Gussnaht auf Mittelachse, Rückseite flach und undekoriert.",
  ...
  },
  {
    ...
    status: "COMPLETED", reported: true,
    dating: "1697", datingFrom: 1697, datingTo: 1697,
    ...
    descriptionFront: "Geharnischtes Brustbild Friedrich Augusts I. nach rechts, Umschrift: \"FRID·AUG·D·G·DUX·SAX·\".",
    descriptionBack: "Kursächsisches Vollwappen, Umschrift: \"ILH·ANNO·1697\", Wert \"1 GROS\" im Abschnitt.",
    tags: ["Frühe Neuzeit"],
  ...
  },
  {
    ...
    status: "DRAFT", reported: false,
    dating: "15.–16. Jh.", datingFrom: 1400, datingTo: 1599,
  ...
  },
  {
    ...
    status: "COMPLETED", reported: false,
    dating: "6.–7. Jh. n. Chr.", datingFrom: 500, datingTo: 700,
  ...
  },
  {
    ...
    status: "DRAFT", reported: false,
    dating: "Mittelalter–Frühe Neuzeit", datingFrom: 1100, datingTo: 1600,
  ...
  },
  {
    ...
    descriptionFront: "Ovaler Rahmen mit zwei stilisierten Drachenköpfen an den Seiten, Dorn zentral.",
    descriptionBack: "Reste der Eisenspange für Ledergurt, Korrosionsspuren.",
  ...
  },
  {
    ...
    status: "COMPLETED", reported: true,
    dating: "2.–1. Jh. v. Chr.", datingFrom: -200, datingTo: -50,
    ...
    descriptionFront: "Abstraktes Kopfbild mit büschelartigem Haar, teilweise dezentriert geprägt.",
    descriptionBack: "Springendes Pferd nach rechts, darunter Torques-Symbol, Punzen im Hintergrund.",
    tags: ["Antike"],
  ...
  for (let i = 0; i < DEMO_FINDINGS.length; i++) {
    ...
    const finding = await prisma.finding.create({
      data: {
        ...
        dating: f.dating, datingFrom: f.datingFrom, datingTo: f.datingTo,
  ...
  for (let i = 0; i < JONAS_FINDINGS.length; i++) {
    ...
    const finding = await prisma.finding.create({
      data: {
        ...
        descriptionFront: f.descriptionFront ?? null,
        descriptionBack: f.descriptionBack ?? null,
        foundAt: f.foundAt,
        userId: jonasUser.id,
        tags: tagIds.length ? { connect: tagIds.map((id) => ({ id })) } : undefined,
      },
